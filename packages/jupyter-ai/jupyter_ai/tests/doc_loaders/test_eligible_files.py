...
class TestCollectFiles(unittest.TestCase):
    ...
    test_dir_contents = {'0' : ['file0.html', '.hidden_file.pdf'], # top level folder, 1 valid file
        'subdir' : ['file1.txt','.hidden_file.txt','file2.py','file3.xyz'], # subfolder, 2 valid files
        '.hidden_dir' : ['file3.csv', 'file4.pdf']} # hidden subfolder, no valid files
