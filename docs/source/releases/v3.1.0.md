...
We have also added comprehensive Persona API documentation! See the [persona-manager Python API reference](https://jupyter-ai.readthedocs.io/en/latest/contributors/jupyter-ai-persona-manager/python-api.html).
...
:::{warning}
Jupyternaut's documentation is currently out of date and may not reflect its behavior in 3.1. See [jupyter-ai#1618](https://github.com/jupyterlab/jupyter-ai/issues/1618) for details and progress.
:::
<!-- END SUMMARY -->
...
Upgraded from `v0.2.5` → `v0.3.1`. ([See full changelog](https://github.com/jupyter-ai-contrib/jupyter-server-documents/releases))
...
Upgraded from `v0.0.11` → `v0.1.1`. ([See full changelog](https://github.com/jupyter-ai-contrib/jupyter-ai-persona-manager/releases))
...
Upgraded from `v0.1.5` → `v0.2.0`. ([See full changelog](https://github.com/jupyter-ai-contrib/jupyter-ai-acp-client/releases))
...
Upgraded from `v0.5.2` → `v0.6.1`. ([See full changelog](https://github.com/jupyter-ai-contrib/jupyter-ai-tools/releases))
...
Upgraded from `v0.0.11` → `v0.1.0b0`. ([See full changelog](https://github.com/jupyter-ai-contrib/jupyter-ai-jupyternaut/releases))
