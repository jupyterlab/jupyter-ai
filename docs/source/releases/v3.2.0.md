...
A new package, [`jupyter-live-content`](https://github.com/jupyter-ai-contrib/jupyter-live-content), has been introduced to update the UI in response to file changes on disk. Agent edits to `.py` and `.md` files, for example, are always immediately reflected in the browser, even without RTC. This fixes a real gap in the default JupyterLab experience, and we will work with other maintainers to upstream this project.
