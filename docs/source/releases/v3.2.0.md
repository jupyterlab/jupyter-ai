...
These are the auto-generated release notes for Jupyter AI **v3.2.0** from the `main` branch, aggregated from the subpackages whose version floors advanced in this release. Each subpackage section covers the pull requests merged between its floor at the previous release (v3.1.3) and its floor at v3.2.0.
