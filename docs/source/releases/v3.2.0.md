...
Upgraded from `v0.23.2` → `v0.25.0rc0`. ([See full changelog](https://github.com/jupyterlab/jupyter-chat/releases))
...
Upgraded from `v0.0.7` → `v0.1.0rc0`. ([See full changelog](https://github.com/jupyter-ai-contrib/jupyter-ai-router/releases))
...
Upgraded from `v0.1.2` → `v0.2.0rc0`. ([See full changelog](https://github.com/jupyter-ai-contrib/jupyter-ai-persona-manager/releases))
...
Upgraded from `v0.2.1` → `v0.3.0rc0`. ([See full changelog](https://github.com/jupyter-ai-contrib/jupyter-ai-acp-client/releases))
