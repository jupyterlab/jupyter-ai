...
[`jupyter-ai-contrib`](https://github.com/jupyter-ai-contrib) GitHub org.
...
[jupyter-ai-devrepo](https://github.com/jupyter-ai-contrib/jupyter-ai-devrepo)
is a "developer repo" intended for Jupyter AI contributors. This facilitates
installing Jupyter AI along with all its submodules with a small number of
steps. By cloning the repo and following the steps below, you can have an
editable developer installation of all Jupyter AI subpackages.
